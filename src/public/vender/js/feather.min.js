    ...
    return (function (e) {
        ...
        function (e, n, i) {
            ...
            e.exports = function (e, n, i, f, d, v, g) {
                ...
                if (
                    (O &&
                        (w = h(O.call(new e()))) !== Object.prototype &&
                        w.next &&
                        (p(w, A, !0), t || a(w, x) || o(w, x, u)),
                    _ &&
                        S &&
                        'values' !== S.name &&
                        ((z = !0),
                    ...
                    if (
                        ...
                        for (M in m) M in k || r(k, M, m[M])
                    else l(l.P + l.F * (s || z), n, m)
                return m
            }
        },
        function (e, n, i) {
...
*/
            !(function () {
                ...
                var i = (function () {
                    ...
                    function l(e, n) {
                        for (
                            var i = n.split(c), t = i.length, l = 0;
                            l < t;
                            ++l
                        )
                            e[i[l]] = !0
        ...
        function (e, n, i) {
            for (
                ...
                if (
                    M &&
                    (M[p] || a(M, p, x), M[h] || a(M, h, v), (c[v] = x), g)
                )
                    for (d in t) M[d] || r(M, d, t[d], !0)
            }
        },
        function (e, n, i) {
            'use strict'
                ...
                getConstructor: function (e, n, i, y) {
                    ...
                    return (
                        r(p.prototype, {
                            clear: function () {
                                for (
                                    var e = u(this, n), i = e._i, t = e._f;
                                    t;
                                    t = t.n
                                )
                                    (t.r = !0),
                                        t.p && (t.p = t.p.n = void 0),
                                        delete i[t.i]
                    ...
                    ('__proto__' in {}
                        ? (function (e, n, t) {
                              try {
                                  ;(t = i(11)(
                                      Function.call,
                                      i(77).f(Object.prototype, '__proto__')
                                          .set,
                                      2,
                                  )),
                                      t(e, []),
